...
const sdk = new LandfallSdk({
  collectorUrl: process.env.LANDFALL_COLLECTOR_URL ?? "http://localhost:8080",
});

sdk.capture(
  buildTraceCreated(context(), {
    flow: "checkout",
    transaction_version: "legacy",
  }),
);
sdk.capture(
  buildSigningStarted(context(), {
    signing_id: "0198ef00-0000-7000-8000-000000000501",
    transaction_version: "legacy",
  }),
);
sdk.capture(
  buildSubmissionStarted(context(), {
    attempt_id: generateUuidV7(),
    route_id: "0198ef00-0000-7000-8000-000000000400",
    attempt_sequence: 1,
    encoding: "base64",
